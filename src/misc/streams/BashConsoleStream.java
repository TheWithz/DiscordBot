 ...
 */
public class BashConsoleStream {
    private TextChannel channel;
    private RedirectStream systemOut;
    private RedirectStream systemErr;

    public BashConsoleStream(TextChannel channel) {
        this(channel, false);
    }

    public BashConsoleStream(TextChannel channel, boolean enable) {
        setChannel(channel);
    ...
    private abstract class RedirectStream extends PrintStream {
        ...
        public void println() {
            ...
            BashConsoleStream.this.printToDiscord("\n");
        }
        ...
        public void println(String s) {
            ...
            BashConsoleStream.this.printToDiscord(s + "\n");
        }
