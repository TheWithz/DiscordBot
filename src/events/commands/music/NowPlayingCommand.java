...
//        if (player == null) {
//            event.getChannel().sendMessage(":x: Cannot show information for a song that is not playing!").queue();
//            return;
//        }
...
//                                    convert(total, currentTime, player.getVolume(), "play", player.isRepeat(), player.isShuffle())).queue();
//                } else if (player.isPaused()) {
//                    event.getChannel().sendMessage(
//                            ":white_check_mark: **Playing:** " + info.getTitle() + "\n" +
//                                    convert(total, currentTime, player.getVolume(), "pause", player.isRepeat(), player.isShuffle())).queue();
//                }
//            } else {
//                if (player.isPlaying()) {
//                    event.getChannel().sendMessage(
...
//            }
//        } else {
//            event.getChannel().sendMessage(":x: The player is not currently playing anything!").queue();
//        }
    }
